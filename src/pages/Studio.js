...
import background from '../assets/studio_back.png'
...
function Studio() {
    ...
    return (
        <div className='studioDiv'>
            <div className='studioBack'>
                <img src={background} alt="background_game" className='studio_background'></img>
                <div className='studioback_overlay'></div>
                <div className='studioBack_inner'>
                    ...
                    <button className='studio_followbtn'>
            ...
            <div className='studio_bottom'>
                <div className='studio_stats'>
                ...
                <div className='studio_social'>
                    <div className='studio_socialfriends'>
                    ...
                    <p><b>@user_{random1}, @user_{random2}</b> & {random_users} other follow this studio</p>
                </div>
            </div>
